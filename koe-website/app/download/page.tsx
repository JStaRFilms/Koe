    ...
    return (
        <>
            ...
            <main className="flex-grow flex flex-col">
                <section className="max-w-7xl mx-auto w-full border-x border-zinc py-16 md:py-24 px-4 md:px-8">
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="border border-zinc p-8 text-center">
                            <h3 className="font-deco text-xl mb-4 text-bone">OPEN SOURCE</h3>
                        ...
                        <div className="mt-16 grid md:grid-cols-2 gap-8">
                            <div>
                                <h3 className="font-deco text-xl mb-6 text-bone uppercase tracking-wider">System Requirements</h3>
                                <ul className="space-y-4 text-muted normal-case">
                            ...
                            <div>
                                <h3 className="font-deco text-xl mb-6 text-bone uppercase tracking-wider">Installation</h3>
                                <ol className="space-y-4 text-muted normal-case">
