                ...
                <div className="max-w-4xl mx-auto w-full border-x border-zinc bg-void shadow-2xl">
                    <article className="p-8 md:p-16 flex flex-col gap-16">
                        ...
                        <div className="mt-8 p-12 border border-zinc bg-zinc/10 text-center flex flex-col items-center">
                            ...
                            <a href="https://github.com/GIGAHAT1994/whisper_alt/issues" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-amber text-void px-8 py-4 font-bold text-lg border-2 border-amber hover:bg-bone hover:border-bone transition-colors relative group">
